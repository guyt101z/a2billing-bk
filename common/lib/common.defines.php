...
// A2BILLING INFO
define ("COPYRIGHT", "Blue-Swans v2.0.1 is a ".'<a href="http://en.wikipedia.org/wiki/Voip" target="_blank">voip service</a>' . " This Software is licensed under the ".'<a href="http://www.fsf.org/licensing/licenses/agpl-3.0.html" target="_blank">AGPL 3</a>' . ". <br/>" . "Copyright (C) 2004-2012  <a href=\"http://www.star2billing.com\" target=\"_blank\">Forked from Star2billing S.L.</a>");

define ("CCMAINTITLE", gettext("Blue-Swans Enterprises"));
